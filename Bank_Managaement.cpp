...
void account::investment()
{
    ...
    case 1:
        cout<<" 1)Cryptocurrency:\n "<<endl;
           ...
           cout<<"* Many cryptocurrencies are decentralized networks based on blockchain technology distributed ledger enforced by a\n  disparate network of computers."<<endl;
  ...
  HANDLE h=GetStdHandle(STD_OUTPUT_HANDLE);
   SetConsoleTextAttribute(h,6);
       ...
       do
       {
              ...
              case '0':
              SetConsoleTextAttribute(h,12);
                     cout << "\n\n\tThanks for using Bank Management and Investment System..!!!";
                     break;
              default:
                     cout << "\a";
              }
